    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Manage Withdraw</h3>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"
                        ...
                        <button type="button" id="btnwithdraw" class="dropdown-item text-info"><span
                                class="la la-plus-circle font-medium-3 icon-left"></span>New</button>
                        <div class="dropdown-divider"></div>
                        <form method="POST" action="withdraw_action.php">
...
<!-- new Modal -->
<div class="modal fade text-left" id="withdrawmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel25"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title text-text-bold-600" id="myModalLabel25">Player Withdraw</label>
...
<script>
var withdraw_url = "<?php echo roothtml.'wallet/withdraw_action.php'; ?>";
...
$(document).ready(function() {
    ...
    $(document).on("click", "#btnwithdrawconfirm", function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Withdraw Success',
            cancelButtonText: 'Withdraw Fail',
                    ...
                    success: function(data) {
                        if (data == 1) {
                            ...
                            Swal.fire({
                                position: 'top-end',
                                icon: 'error',
                                title: 'Withdraw failed. Please try again.',
                                showConfirmButton: false,
                                timer: 3000,
                                toast: true
                            });
                    ...
                    success: function(data) {
                        if (data == 1) {
                            Swal.fire({
                                position: 'top-end',
                                icon: 'success',
                                title: 'Withdraw canceled successfully.',
                                showConfirmButton: false,
                                timer: 3000,
                                toast: true
                            });
                            ...
                            Swal.fire({
                                position: 'top-end',
                                icon: 'error',
                                title: 'Withdraw canceled failed. Please try again.',
                                showConfirmButton: false,
                                timer: 3000,
                                toast: true
                            });
            ...
            success: function(data) {
                if (data == 1) {
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Save withdraw is successful.',
                        showConfirmButton: false,
                        timer: 3000,
                        toast: true
                    });
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'warning',
                        title: 'Withdraw balance Not enough balance.',
                        showConfirmButton: false,
                        timer: 3000,
                        toast: true
                    });
