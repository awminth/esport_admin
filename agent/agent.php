    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Manage Agent</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=roothtml.'home/home.php'?>">Home</a>
                            </li>
                            <li class="breadcrumb-item active">Manage Agent
                            </li>
                        </ol>
                    </div>
                </div>
...
$(document).ready(function() {
    function load_page(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'agent/agent_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $("#frmsave").on("submit", function(e) {
        ...
        if (min == "" || min <= 0) {
            Swal.fire("Warning", "Minimum Bet must at least 1Kyat.", "warning");
            return false;
        }
        //Check Maximum Bet
        var max = $("[name='max']").val();
        if (max == "" || max < 1000) {
            Swal.fire("Warning", "Maximum Bet must at least 1000Kyat.", "warning");
            return false;
        }
        //Check Maximum Bet Per Match
        var maxpermatch = $("[name='maxpermatch']").val();
        if (maxpermatch == "" || maxpermatch <= 0) {
            Swal.fire("Warning", "Maximum Bet Per Match must at least 1Kyat.", "warning");
            return false;
        }
