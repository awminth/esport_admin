    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Running Report</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=roothtml.'home/home.php'?>">Home</a>
                            </li>
                            <li class="breadcrumb-item active">Running Report
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-content collapse show">
                            ...
                            <hr>
                            <div class="form-group col-md-12 pt-1">
                                <form method="POST" action="runningreport_action.php">
...
<script>
var runningreport_url = "<?php echo roothtml.'reports/runningreport_action.php'; ?>";
