...
if($action == 'excel'){
    ...
    ORDER BY d.AID DESC";
    $result = $con->query($sql);
    $fileName = "CancelCasinoBetList_".date('d-m-Y').".xls";
    $out .= '
        <head><meta charset="UTF-8"></head>
        <table >  
            <tr>
                <td colspan="6" align="center"><h3>Cancel Casino Bet List</h3></td>
            </tr>
...
if($action == 'pdf'){
    ...
    ORDER BY d.AID DESC";
    $result = $con->query($sql);
    $out .= '<h3 align="center">Cancel Casino Bet List</h3>
        <head><meta charset="UTF-8"></head>
        <table >  
            <tr>  
                <th style="border: 1px solid ;">No</th>  
    ...
    $file = 'CancelCasinoBetList_'.date("d_m_Y").'.pdf';
    $mpdf->output($file,'D');
