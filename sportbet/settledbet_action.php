    ...
    if ($result->num_rows > 0) {
        ...
        <thead>
            <tr> 
                ...
                <th>Account Name</th>
                <th>Ticket ID</th>   
                <th class="text-right">Bet Amt</th>  
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $out .= '
                <tr>
                    ...
                    <td class="text-right text-info">'.number_format($bet_amt).'</td>
...
if($action == 'excel'){
    ...
    $out .= '
        ...
        <table >  
            <tr>
                <td colspan="6" align="center"><h3>Settled Sport Bet List</h3></td>
            </tr>
...
if($action == 'pdf'){
    ...
    $result = $con->query($sql);
    $fileName = "SettledSportBetList_".date('d-m-Y').".xls";
    $out .= '<h3 align="center">Settled Sport Bet List</h3>
        <head><meta charset="UTF-8"></head>
        <table >  
            <tr>  
                <th style="border: 1px solid ;">No</th>  
    ...
    $file = 'SettledSportBetList_'.date("d_m_Y").'.pdf';
    $mpdf->output($file,'D');
